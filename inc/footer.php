<div class="footer">
	<div class="container">
		<div class="hotlineFooter"><span>BẠN CẦN TƯ VẤN? HÃY GỌI CHÚNG TÔI:</span> <strong>(028) 12-000-123</strong> <img src="<?php echo APP_ASSETS ?>img/icoSupport.png" alt=""></div>
		<div class="listBlockFooter">
			<div class="blockF block01">
				<img src="<?php echo APP_ASSETS ?>img/logo.png" alt="">
		...
		<div class="newsLetter">
			<div class="newsLetter__text">Để lại email để được nhận các chương trình khuyến mãi :</div>
			...
			<div class="newsLetter__imgs">
				<img src="<?php echo APP_ASSETS ?>img/payment.png" alt="">
			</div>
		</div>
