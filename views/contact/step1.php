...
<form method="post" class="form-1" action="<?php echo $script ?>?<?php echo $gtime ?>" name="form1" onSubmit="return check()">
	<div class="formBlock container">
		...
		<p class="taC t20b0"><img src="<?php echo APP_ASSETS; ?>img/contact/imgStep01.png" alt=""/></p>
		...
		<table class="tableContact" cellspacing="0">
			...
			<tr>
				...
				<td>
					<p class="floatL"><input placeholder="例) 000-000-0000" type="tel"  name="tel" id="tel"></p>
			...
			<tr>
				<th>【任意】おFAX番号</th>
				<td>
          <p class="floatL"><input placeholder="例) 000-000-0000" type="tel"  name="fax" id="fax"></p>
          <p class="floatL ml10">※半角数字でご記入ください。</p>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="clearfix t0b10">
						...
						<div class="dIB size01">
							<input type="text" placeholder="例) 000-0000" name="zipcode" id="zipcode" onKeyUp="AjaxZip3.zip2addr(this,'','pref_name','address01')" >
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<th><em>【必須】</em>住所</th>
				<td class="clearfix">
					<select name="pref_name" id="pref_name" class="chkselect">
					...
					<div class="clearfix mt10">
						<p class="floatL">
							<input placeholder="例) 明石市○○" type="text" name="address01" id="address01">
						</p>
						<p class="floatL ml10">市区町村・番地など</p>
					</div>
					<div class="clearfix mt10">
						<p class="floatL">
							<input placeholder="例) ○○○○3F" type="text" name="address02" id="address02">
						</p>
			...
			<tr>
				...
				<td>
					<p><input placeholder="例) xxxxx@sample.co.jp" type="email" name="email" id="email"></p>
					<p class="mt10"><input placeholder="例) xxxxx@sample.co.jp" type="email"  name="cemail" id="cemail" value=""></p>
				</td>
			</tr>
			<tr>
    ...
    <div class="taC">
    	...
    	<p class="t30b20"><button name="actionFlag" value="confirm"><span>入力内容を確認する</span></button></p>
    </div>
